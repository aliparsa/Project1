 ...
 */
public class ProjectTreeViewCustomAdapter extends ArrayAdapter<AdapterInputType> {
    ...
    public ProjectTreeViewCustomAdapter(Context context, int layoutResourceID,
